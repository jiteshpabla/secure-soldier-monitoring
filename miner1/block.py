...
class Block(object):
  def __init__(self, dictionary):   #Constructor
    for key, value in dictionary.items():
      if key in BLOCK_VAR:
        setattr(self, key, BLOCK_VAR[key](value))
      else:
  ...
  ''' Utility Function Comprises Generating and Extracting Header String, Self Saving, Hashing, Validation '''
  ...
  def is_valid(self):   # Checking Validity only through Nonces
  ...
  def __eq__(self, other):  # Comparison For Equality
